...
async def chat(input_messages: list[SamplingMessage], max_tokens=4000):
    """Sends a chat request to the Anthropic API using the provided input messages."""
    messages = []
...
async def sampling_callback(
    ...
    """Handles the sampling callback by calling Claude using the Anthropic SDK."""
...
async def run():
    """Runs the client, connecting to the server via stdio."""
